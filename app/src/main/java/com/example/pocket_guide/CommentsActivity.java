...
import com.example.pocket_guide.Adapter.CommentAdapter;
import com.example.pocket_guide.Model.Comment;
    ...
    private void getImage(){
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Glide.with(getApplicationContext()).load(user.getimagetoken()).into(image_profile);
            }
